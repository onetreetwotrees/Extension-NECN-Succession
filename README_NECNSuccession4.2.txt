...
Welcome to the source code repository for Extension-NECN-Succession, a LANDIS-II succession extension.

Extension-NECN-Succession is a hybrid between the Century soil model and the LANDIS-II Biomass Succession 
extension.  NECN Succession calculates how cohorts grow, reproduce, age, and die.  Dead biomass is tracked 
over time, divided into four pools:  surface wood, soil wood (dead coarse roots), surface litter (dead leaves), 
and soil litter (dead fine roots).  In addition, three principle soil pools:  fast (soil organic matter (SOM) 1), 
slow (SOM2), and passive (SOM3) are simulated. 
